...
function setPageEvent()
{
	...
	customSpeaker.each(function(){
		...
		$(this).off("click").on("click",function(){
			...
			var isPlay = ($(this).attr("data-play")=="false" ? true : false);
			if(isPlay)
			{
				customSpeaker.attr("data-play", "false");
...
function popAudio_quiz4($type)
{
	var ok = new Audio('./common/audio/quiz4/ok.mp3');
	var get = new Audio('./common/audio/quiz4/get.mp3');
	var not = new Audio('./common/audio/quiz4/not.mp3');
	var click = new Audio('./common/audio/quiz4/click.mp3');
	var ans = new Audio('./common/audio/quiz4/ans.mp3');
	var no = new Audio('./common/audio/quiz4/no.mp3');
...
function popAudio_quiz5($type)
{
	var ok = new Audio('./common/audio/quiz5/ok.mp3');
	var end = new Audio('./common/audio/quiz5/end.mp3');
	var not = new Audio('./common/audio/quiz5/not.mp3');
	var click = new Audio('./common/audio/quiz5/click.mp3');
	var ans = new Audio('./common/audio/quiz5/ans.mp3');
	var no = new Audio('./common/audio/quiz5/no.mp3');
	var on = new Audio('./common/audio/quiz5/on.mp3');
...
function alertShowHide($box, type, $callback, $option)
{
	switch (type)
	{
		...
		case "correct2":
			$box.find(".quiz-alert-box").html('<div class="quiz-alert-img-box correct2"></div>');

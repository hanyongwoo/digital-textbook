...
function setAmList()
{
	...
	else if(Number(bookIdArr[0]) == 17)
	{
		fileName = "17_01";
		amListunitTtl += "의사소통";
		accTxt = "의사소통";
	}
	else if(Number(bookIdArr[0]) == 18)
	{
		fileName = "18_01";
		amListunitTtl += "자립생활";
		accTxt = "자립생활";
	}
	else if(Number(bookIdArr[0]) == 19)
	{
		fileName = "19_01";
		amListunitTtl += "신체활동";
		accTxt = "신체활동";
	}
	else if(Number(bookIdArr[0]) == 20)
	{
		fileName = "20_01";
		amListunitTtl += "여가활동";
		accTxt = "여가활동";
	}
	else if(Number(bookIdArr[0]) == 21)
	{
		fileName = "21_01";
		amListunitTtl += "생활적응(시각중복)";
		accTxt = "생활적응(시각중복)";
	}
	else if(Number(bookIdArr[0]) == 22)
	{
		fileName = "22_01";
		amListunitTtl += "생활적응(청각중복)";
		accTxt = "생활적응(청각중복)";
	}
	else if(Number(bookIdArr[0]) == 23)
	{
		fileName = "23_01";
		amListunitTtl += "생활적응(지체중복)";
		accTxt = "생활적응(지체중복)";
	}
	...
	{
		fileName2 += "17_1_1_"+unitId;
	}
	else if(Number(bookIdArr[0]) == 18)
	{
		fileName2 += "18_1_1_"+unitId;
	}
	else if(Number(bookIdArr[0]) == 19)
	{
		fileName2 += "19_1_1_"+unitId;
	}
	else if(Number(bookIdArr[0]) == 20)
	{
		fileName2 += "20_1_1_"+unitId;
	}
	else if(Number(bookIdArr[0]) == 21)
	{
		fileName2 += "21_1_1_"+unitId;
	}
	else if(Number(bookIdArr[0]) == 22)
	{
		fileName2 += "22_1_1_"+unitId;
	}
	else if(Number(bookIdArr[0]) == 23)
	{
		fileName2 += "23_1_1_"+unitId;
	}
	else if(Number(bookIdArr[0]) == 86)
	{
		if(Number(bookIdArr[1]) == 2)
	...
	if(
		!(bookId=="17_01_01") && !(bookId=="18_01_01") && !(bookId=="19_01_01") && !(bookId=="20_01_01") && !(bookId=="21_01_01") && !(bookId=="22_01_01") && !(bookId=="23_01_01")
	)
	{
	...
	tag +=	 '</div>';
		...
		(bookId=="17_01_01") || (bookId=="18_01_01") || (bookId=="19_01_01") || (bookId=="99_99_99") ||
		(bookId=="21_01_01") || (bookId=="99_99_99") || (bookId=="23_01_01")
	)
	{
	tag +=						'<button data-btn="ui-btn" class="unit-con-title" tabindex="5001" title="이. 요약 노트 다운로드 버튼" aria-label="이. 요약 노트 다운로드 버튼" data-down="./down/'+fileName2+'_summary.zip">';
	tag +=							'<div class="unit-con-title-txt txt">';
	tag +=								'<p>1. 요약 노트</p>';
	tag +=							'</div>';
	tag +=							'<div class="unit-con-title-page"></div>';
...
function setReferenceList()
{
	...
	if( !(bookId=="01_01_01" && unitId == 4) && !(bookId=="01_01_01" && unitId == 5) &&
		...
		!(bookId=="19_01_01" && unitId == 11) && !(bookId=="19_01_01" && unitId == 12) &&
		!(bookId=="20_01_01" && unitId == 6) && !(bookId=="20_01_01" && unitId == 8) && !(bookId=="20_01_01" && unitId == 14) &&
		!(bookId=="21_01_01" && unitId == 4) &&
		!(bookId=="22_01_01" && unitId == 1) && !(bookId=="22_01_01" && unitId == 6) && !(bookId=="22_01_01" && unitId == 8) &&
		!(bookId=="23_01_01" && unitId == 2) && !(bookId=="23_01_01" && unitId == 3)*/
	)
	{
	tag +=				'<div class="unit-box">';
